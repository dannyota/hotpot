...
const ENDPOINT = '/api/v1/bronze/gcp/compute/global-forwarding-rules'
...
const drawerFields: DrawerFieldDef[] = [
  ...
  { key: 'ip_protocol', label: 'IP Protocol' },
  { key: 'port_range', label: 'Port Range' },
  { key: 'load_balancing_scheme', label: 'Load Balancing Scheme' },
...
<template>
  <HTablePage
    ...
    export-filename="gcp-compute-global-forwarding-rules.csv"
    title="Global Forwarding Rules"
  />
</template>
