...
const ENDPOINT = '/api/v1/bronze/gcp/compute/url-maps'

const columns: ColumnDef[] = [
  { key: 'name', format: 'bold' },
  { key: 'default_service', label: 'Default Service', transform: shortPath },
...
<template>
  <HTablePage
    ...
    export-filename="gcp-compute-url-maps.csv"
    title="URL Maps"
  />
</template>
