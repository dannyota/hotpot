...
const ENDPOINT = '/api/v1/bronze/gcp/compute/target-tcp-proxies'

const columns: ColumnDef[] = [
  { key: 'name', format: 'bold' },
  { key: 'service', transform: shortPath },
  { key: 'proxy_header', label: 'Proxy Header' },
...
const drawerFields: DrawerFieldDef[] = [
  ...
  { key: 'service', label: 'Service', transform: shortPath },
  { key: 'proxy_header', label: 'Proxy Header' },
...
<template>
  <HTablePage
    ...
    export-filename="gcp-compute-target-tcp-proxies.csv"
    title="Target TCP Proxies"
  />
</template>
