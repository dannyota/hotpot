...
const ENDPOINT = '/api/v1/bronze/gcp/compute/security-policies'

const typeBadge = badgeColors({
  CLOUD_ARMOR: badge.blue,
  CLOUD_ARMOR_EDGE: badge.purple,
  CLOUD_ARMOR_NETWORK: badge.amber,
})
...
<template>
  <HTablePage
    ...
    export-filename="gcp-compute-security-policies.csv"
