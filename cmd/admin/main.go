...
import (
	...
	rootadmin "danny.vn/hotpot/admin"
...
func main() {
	...
	application.Run(func(ctx context.Context, configService *config.Service, driver dialect.Driver) error {
		return admin.Run(ctx, configService, driver, rootadmin.DistFS)
	})
