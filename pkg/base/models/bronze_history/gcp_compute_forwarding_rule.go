...
// GCPComputeForwardingRule stores historical snapshots of GCP Compute regional forwarding rules.
...
type GCPComputeForwardingRule struct {
	...
	// All forwarding rule fields (same as bronze.GCPComputeForwardingRule)
...
func (GCPComputeForwardingRule) TableName() string {
	return "bronze_history.gcp_compute_forwarding_rules"
}

// GCPComputeForwardingRuleLabel stores historical snapshots of forwarding rule labels.
// Links via ForwardingRuleHistoryID, has own valid_from/valid_to for granular tracking.
type GCPComputeForwardingRuleLabel struct {
	HistoryID               uint `gorm:"primaryKey"`
	ForwardingRuleHistoryID uint `gorm:"column:forwarding_rule_history_id;not null;index" json:"-"`
...
func (GCPComputeForwardingRuleLabel) TableName() string {
	return "bronze_history.gcp_compute_forwarding_rule_labels"
}
