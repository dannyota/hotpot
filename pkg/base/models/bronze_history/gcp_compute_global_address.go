...
// GCPComputeGlobalAddress stores historical snapshots of GCP Compute global addresses.
...
type GCPComputeGlobalAddress struct {
	...
	// All address fields (same as bronze.GCPComputeGlobalAddress)
...
func (GCPComputeGlobalAddress) TableName() string {
	return "bronze_history.gcp_compute_global_addresses"
}

// GCPComputeGlobalAddressLabel stores historical snapshots of global address labels.
// Links via GlobalAddressHistoryID, has own valid_from/valid_to for granular tracking.
type GCPComputeGlobalAddressLabel struct {
	HistoryID              uint `gorm:"primaryKey"`
	GlobalAddressHistoryID uint `gorm:"column:global_address_history_id;not null;index" json:"-"`
...
func (GCPComputeGlobalAddressLabel) TableName() string {
	return "bronze_history.gcp_compute_global_address_labels"
}
