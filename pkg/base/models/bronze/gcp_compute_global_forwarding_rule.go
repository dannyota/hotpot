...
// GCPComputeGlobalForwardingRule represents a GCP Compute Engine global forwarding rule in the bronze layer.
...
type GCPComputeGlobalForwardingRule struct {
	...
	Labels []GCPComputeGlobalForwardingRuleLabel `gorm:"foreignKey:GlobalForwardingRuleResourceID;references:ResourceID" json:"labels,omitempty"`
}

func (GCPComputeGlobalForwardingRule) TableName() string {
	return "bronze.gcp_compute_global_forwarding_rules"
}

// GCPComputeGlobalForwardingRuleLabel represents a label attached to a GCP Compute global forwarding rule.
type GCPComputeGlobalForwardingRuleLabel struct {
	ID                                uint   `gorm:"primaryKey"`
	GlobalForwardingRuleResourceID    string `gorm:"column:global_forwarding_rule_resource_id;type:varchar(255);not null;index" json:"-"`
...
func (GCPComputeGlobalForwardingRuleLabel) TableName() string {
	return "bronze.gcp_compute_global_forwarding_rule_labels"
}
