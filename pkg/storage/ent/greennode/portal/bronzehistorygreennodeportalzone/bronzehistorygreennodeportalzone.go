...
const (
	// Label holds the string label denoting the bronzehistorygreennodeportalzone type in the database.
	Label = "bronze_history_green_node_portal_zone"
	...
	// Table holds the table name of the bronzehistorygreennodeportalzone in the database.
	Table = "greennode_portal_zones_history"
)

// Columns holds all SQL columns for bronzehistorygreennodeportalzone fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGreenNodePortalZone queries.
