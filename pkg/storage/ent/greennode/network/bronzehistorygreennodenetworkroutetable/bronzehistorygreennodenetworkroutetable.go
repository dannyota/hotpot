...
const (
	// Label holds the string label denoting the bronzehistorygreennodenetworkroutetable type in the database.
	Label = "bronze_history_green_node_network_route_table"
	...
	// Table holds the table name of the bronzehistorygreennodenetworkroutetable in the database.
	Table = "greennode_network_route_tables_history"
)

// Columns holds all SQL columns for bronzehistorygreennodenetworkroutetable fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGreenNodeNetworkRouteTable queries.
