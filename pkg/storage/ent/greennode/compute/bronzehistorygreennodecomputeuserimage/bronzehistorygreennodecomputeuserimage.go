...
const (
	// Label holds the string label denoting the bronzehistorygreennodecomputeuserimage type in the database.
	Label = "bronze_history_green_node_compute_user_image"
	...
	// Table holds the table name of the bronzehistorygreennodecomputeuserimage in the database.
	Table = "greennode_compute_user_images_history"
)

// Columns holds all SQL columns for bronzehistorygreennodecomputeuserimage fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGreenNodeComputeUserImage queries.
