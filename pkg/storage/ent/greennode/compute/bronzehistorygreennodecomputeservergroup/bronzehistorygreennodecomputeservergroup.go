...
const (
	// Label holds the string label denoting the bronzehistorygreennodecomputeservergroup type in the database.
	Label = "bronze_history_green_node_compute_server_group"
...
// Columns holds all SQL columns for bronzehistorygreennodecomputeservergroup fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGreenNodeComputeServerGroup queries.
