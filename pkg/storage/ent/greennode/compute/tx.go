...
func (tx *Tx) init() {
	tx.BronzeGreenNodeComputeOSImage = NewBronzeGreenNodeComputeOSImageClient(tx.config)
	...
	tx.BronzeGreenNodeComputeUserImage = NewBronzeGreenNodeComputeUserImageClient(tx.config)
	tx.BronzeHistoryGreenNodeComputeOSImage = NewBronzeHistoryGreenNodeComputeOSImageClient(tx.config)
	...
	tx.BronzeHistoryGreenNodeComputeUserImage = NewBronzeHistoryGreenNodeComputeUserImageClient(tx.config)
}
...
// applies a query, for example: BronzeGreenNodeComputeOSImage.QueryXXX(), the query will be executed
