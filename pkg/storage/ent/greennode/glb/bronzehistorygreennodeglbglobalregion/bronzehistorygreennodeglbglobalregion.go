...
const (
	// Label holds the string label denoting the bronzehistorygreennodeglbglobalregion type in the database.
	Label = "bronze_history_green_node_glb_global_region"
	...
	// Table holds the table name of the bronzehistorygreennodeglbglobalregion in the database.
	Table = "greennode_glb_global_regions_history"
)

// Columns holds all SQL columns for bronzehistorygreennodeglbglobalregion fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGreenNodeGLBGlobalRegion queries.
