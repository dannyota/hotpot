...
const (
	// Label holds the string label denoting the bronzegreennodeloadbalancercertificate type in the database.
	Label = "bronze_green_node_load_balancer_certificate"
	...
	// Table holds the table name of the bronzegreennodeloadbalancercertificate in the database.
	Table = "greennode_loadbalancer_certificates"
)

// Columns holds all SQL columns for bronzegreennodeloadbalancercertificate fields.
var Columns = []string{
	FieldID,
	FieldCollectedAt,
...
// OrderOption defines the ordering options for the BronzeGreenNodeLoadBalancerCertificate queries.
