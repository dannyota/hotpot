...
const (
	// Label holds the string label denoting the bronzehistorygcpcomputeaddress type in the database.
	Label = "bronze_history_gcp_compute_address"
	...
	// Table holds the table name of the bronzehistorygcpcomputeaddress in the database.
	Table = "gcp_compute_addresses_history"
)

// Columns holds all SQL columns for bronzehistorygcpcomputeaddress fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPComputeAddress queries.
