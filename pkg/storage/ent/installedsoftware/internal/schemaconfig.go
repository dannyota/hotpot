...
type SchemaConfig struct {
	SilverInstalledSoftware           string // SilverInstalledSoftware table.
	SilverInstalledSoftwareBronzeLink string // SilverInstalledSoftwareBronzeLink table.
	SilverInstalledSoftwareNormalized string // SilverInstalledSoftwareNormalized table.
}
