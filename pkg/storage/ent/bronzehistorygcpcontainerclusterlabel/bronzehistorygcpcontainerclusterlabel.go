...
const (
	// Label holds the string label denoting the bronzehistorygcpcontainerclusterlabel type in the database.
	Label = "bronze_history_gcp_container_cluster_label"
	...
	FieldValue = "value"
	// Table holds the table name of the bronzehistorygcpcontainerclusterlabel in the database.
	Table = "gcp_container_cluster_labels_history"
)

// Columns holds all SQL columns for bronzehistorygcpcontainerclusterlabel fields.
var Columns = []string{
	FieldID,
	FieldHistoryID,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPContainerClusterLabel queries.
