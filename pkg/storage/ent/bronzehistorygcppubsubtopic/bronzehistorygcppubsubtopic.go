...
const (
	// Label holds the string label denoting the bronzehistorygcppubsubtopic type in the database.
	Label = "bronze_history_gcp_pub_sub_topic"
	...
	// Table holds the table name of the bronzehistorygcppubsubtopic in the database.
	Table = "gcp_pubsub_topics_history"
)

// Columns holds all SQL columns for bronzehistorygcppubsubtopic fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPPubSubTopic queries.
