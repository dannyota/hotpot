...
const (
	// Label holds the string label denoting the bronzehistorygcpvpntunnellabel type in the database.
	Label = "bronze_history_gcpvpn_tunnel_label"
	// FieldID holds the string denoting the id field in the database.
	FieldID = "id"
	// FieldHistoryID holds the string denoting the history_id field in the database.
	FieldHistoryID = "history_id"
	// FieldVpnTunnelHistoryID holds the string denoting the vpn_tunnel_history_id field in the database.
	FieldVpnTunnelHistoryID = "vpn_tunnel_history_id"
	...
	FieldValue = "value"
	// Table holds the table name of the bronzehistorygcpvpntunnellabel in the database.
	Table = "gcp_compute_vpn_tunnel_labels_history"
)

// Columns holds all SQL columns for bronzehistorygcpvpntunnellabel fields.
var Columns = []string{
	FieldID,
	FieldHistoryID,
	FieldVpnTunnelHistoryID,
	FieldValidFrom,
	FieldValidTo,
	FieldKey,
	FieldValue,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPVPNTunnelLabel queries.
...
// ByVpnTunnelHistoryID orders the results by the vpn_tunnel_history_id field.
func ByVpnTunnelHistoryID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldVpnTunnelHistoryID, opts...).ToFunc()
}
