...
const (
	// Label holds the string label denoting the bronzehistorygcpbigtablecluster type in the database.
	Label = "bronze_history_gcp_bigtable_cluster"
	...
	// Table holds the table name of the bronzehistorygcpbigtablecluster in the database.
	Table = "gcp_bigtable_clusters_history"
)

// Columns holds all SQL columns for bronzehistorygcpbigtablecluster fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPBigtableCluster queries.
