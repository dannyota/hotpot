...
const (
	// Label holds the string label denoting the bronzehistorydodatabasebackup type in the database.
	Label = "bronze_history_do_database_backup"
	...
	// Table holds the table name of the bronzehistorydodatabasebackup in the database.
	Table = "do_database_backups_history"
)

// Columns holds all SQL columns for bronzehistorydodatabasebackup fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryDODatabaseBackup queries.
