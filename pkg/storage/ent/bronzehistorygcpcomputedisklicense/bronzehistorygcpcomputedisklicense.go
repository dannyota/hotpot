...
const (
	// Label holds the string label denoting the bronzehistorygcpcomputedisklicense type in the database.
	Label = "bronze_history_gcp_compute_disk_license"
	...
	// Table holds the table name of the bronzehistorygcpcomputedisklicense in the database.
	Table = "gcp_compute_disk_licenses_history"
)

// Columns holds all SQL columns for bronzehistorygcpcomputedisklicense fields.
var Columns = []string{
	FieldID,
	FieldHistoryID,
	FieldDiskHistoryID,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPComputeDiskLicense queries.
