...
const (
	// Label holds the string label denoting the bronzehistorygcpsqlinstancelabel type in the database.
	Label = "bronze_history_gcpsql_instance_label"
	...
	FieldValue = "value"
	// Table holds the table name of the bronzehistorygcpsqlinstancelabel in the database.
	Table = "gcp_sql_instance_labels_history"
)

// Columns holds all SQL columns for bronzehistorygcpsqlinstancelabel fields.
var Columns = []string{
	FieldID,
	FieldHistoryID,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPSQLInstanceLabel queries.
