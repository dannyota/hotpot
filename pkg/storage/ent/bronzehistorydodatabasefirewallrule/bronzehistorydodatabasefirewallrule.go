...
const (
	// Label holds the string label denoting the bronzehistorydodatabasefirewallrule type in the database.
	Label = "bronze_history_do_database_firewall_rule"
	...
	// Table holds the table name of the bronzehistorydodatabasefirewallrule in the database.
	Table = "do_database_firewall_rules_history"
)

// Columns holds all SQL columns for bronzehistorydodatabasefirewallrule fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryDODatabaseFirewallRule queries.
