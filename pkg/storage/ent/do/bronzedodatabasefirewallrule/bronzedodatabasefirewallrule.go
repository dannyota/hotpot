...
const (
	// Label holds the string label denoting the bronzedodatabasefirewallrule type in the database.
	Label = "bronze_do_database_firewall_rule"
	...
	// Table holds the table name of the bronzedodatabasefirewallrule in the database.
	Table = "do_database_firewall_rules"
)

// Columns holds all SQL columns for bronzedodatabasefirewallrule fields.
var Columns = []string{
	FieldID,
	FieldCollectedAt,
...
// OrderOption defines the ordering options for the BronzeDODatabaseFirewallRule queries.
