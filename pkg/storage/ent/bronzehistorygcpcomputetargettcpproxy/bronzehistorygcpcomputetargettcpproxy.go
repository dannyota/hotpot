...
const (
	// Label holds the string label denoting the bronzehistorygcpcomputetargettcpproxy type in the database.
	Label = "bronze_history_gcp_compute_target_tcp_proxy"
	...
	// Table holds the table name of the bronzehistorygcpcomputetargettcpproxy in the database.
	Table = "gcp_compute_target_tcp_proxies_history"
)

// Columns holds all SQL columns for bronzehistorygcpcomputetargettcpproxy fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPComputeTargetTcpProxy queries.
