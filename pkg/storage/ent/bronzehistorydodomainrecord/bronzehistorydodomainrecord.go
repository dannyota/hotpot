...
const (
	// Label holds the string label denoting the bronzehistorydodomainrecord type in the database.
	Label = "bronze_history_do_domain_record"
	...
	FieldTag = "tag"
	// Table holds the table name of the bronzehistorydodomainrecord in the database.
	Table = "do_domain_records_history"
)

// Columns holds all SQL columns for bronzehistorydodomainrecord fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryDODomainRecord queries.
