...
const (
	// Label holds the string label denoting the bronzehistorygcpstoragebucketiampolicy type in the database.
	Label = "bronze_history_gcp_storage_bucket_iam_policy"
	...
	// Table holds the table name of the bronzehistorygcpstoragebucketiampolicy in the database.
	Table = "gcp_storage_bucket_iam_policies_history"
)

// Columns holds all SQL columns for bronzehistorygcpstoragebucketiampolicy fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPStorageBucketIamPolicy queries.
