...
const (
	// Label holds the string label denoting the bronzehistorydoprojectresource type in the database.
	Label = "bronze_history_do_project_resource"
	...
	FieldStatus = "status"
	// Table holds the table name of the bronzehistorydoprojectresource in the database.
	Table = "do_project_resources_history"
)

// Columns holds all SQL columns for bronzehistorydoprojectresource fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryDOProjectResource queries.
