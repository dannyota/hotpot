...
const (
	// Label holds the string label denoting the bronzehistorys1account type in the database.
	Label = "bronze_history_s1account"
	...
	// Table holds the table name of the bronzehistorys1account in the database.
	Table = "s1_accounts_history"
)

// Columns holds all SQL columns for bronzehistorys1account fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryS1Account queries.
