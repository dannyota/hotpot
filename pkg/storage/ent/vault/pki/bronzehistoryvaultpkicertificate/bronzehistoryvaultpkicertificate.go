...
const (
	// Label holds the string label denoting the bronzehistoryvaultpkicertificate type in the database.
	Label = "bronze_history_vault_pki_certificate"
	...
	// Table holds the table name of the bronzehistoryvaultpkicertificate in the database.
	Table = "vault_pki_certificates_history"
)

// Columns holds all SQL columns for bronzehistoryvaultpkicertificate fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryVaultPKICertificate queries.
