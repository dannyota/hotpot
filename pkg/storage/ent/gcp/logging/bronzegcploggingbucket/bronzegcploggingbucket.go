...
const (
	// Label holds the string label denoting the bronzegcploggingbucket type in the database.
	Label = "bronze_gcp_logging_bucket"
	...
	// Table holds the table name of the bronzegcploggingbucket in the database.
	Table = "gcp_logging_buckets"
)

// Columns holds all SQL columns for bronzegcploggingbucket fields.
var Columns = []string{
	FieldID,
	FieldCollectedAt,
...
// OrderOption defines the ordering options for the BronzeGCPLoggingBucket queries.
