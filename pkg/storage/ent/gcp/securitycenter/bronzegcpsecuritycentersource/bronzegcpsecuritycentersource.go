...
const (
	// Label holds the string label denoting the bronzegcpsecuritycentersource type in the database.
	Label = "bronze_gcp_security_center_source"
	...
	// Table holds the table name of the bronzegcpsecuritycentersource in the database.
	Table = "gcp_securitycenter_sources"
)

// Columns holds all SQL columns for bronzegcpsecuritycentersource fields.
var Columns = []string{
	FieldID,
	FieldCollectedAt,
...
// OrderOption defines the ordering options for the BronzeGCPSecurityCenterSource queries.
