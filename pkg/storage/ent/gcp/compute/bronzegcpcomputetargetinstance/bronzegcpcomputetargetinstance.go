...
const (
	// Label holds the string label denoting the bronzegcpcomputetargetinstance type in the database.
	Label = "bronze_gcp_compute_target_instance"
	...
	// Table holds the table name of the bronzegcpcomputetargetinstance in the database.
	Table = "gcp_compute_target_instances"
)

// Columns holds all SQL columns for bronzegcpcomputetargetinstance fields.
var Columns = []string{
	FieldID,
	FieldCollectedAt,
...
// OrderOption defines the ordering options for the BronzeGCPComputeTargetInstance queries.
