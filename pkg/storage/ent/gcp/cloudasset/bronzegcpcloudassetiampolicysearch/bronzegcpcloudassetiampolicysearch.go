...
const (
	// Label holds the string label denoting the bronzegcpcloudassetiampolicysearch type in the database.
	Label = "bronze_gcp_cloud_asset_iam_policy_search"
	...
	// Table holds the table name of the bronzegcpcloudassetiampolicysearch in the database.
	Table = "gcp_cloudasset_iam_policy_searches"
)

// Columns holds all SQL columns for bronzegcpcloudassetiampolicysearch fields.
var Columns = []string{
	FieldID,
	FieldCollectedAt,
...
// OrderOption defines the ordering options for the BronzeGCPCloudAssetIAMPolicySearch queries.
