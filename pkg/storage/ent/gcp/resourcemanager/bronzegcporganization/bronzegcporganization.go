...
const (
	// Label holds the string label denoting the bronzegcporganization type in the database.
	Label = "bronze_gcp_organization"
	...
	// Table holds the table name of the bronzegcporganization in the database.
	Table = "gcp_organizations"
)

// Columns holds all SQL columns for bronzegcporganization fields.
var Columns = []string{
	FieldID,
	FieldCollectedAt,
...
// OrderOption defines the ordering options for the BronzeGCPOrganization queries.
