...
const (
	// Label holds the string label denoting the bronzegcporgiampolicy type in the database.
	Label = "bronze_gcp_org_iam_policy"
	...
	// BronzeGCPOrgIamPolicyBindingFieldID holds the string denoting the ID field of the BronzeGCPOrgIamPolicyBinding.
	BronzeGCPOrgIamPolicyBindingFieldID = "id"
	// Table holds the table name of the bronzegcporgiampolicy in the database.
	Table = "gcp_org_iam_policies"
	// BindingsTable is the table that holds the bindings relation/edge.
	BindingsTable = "gcp_org_iam_policy_bindings"
	// BindingsInverseTable is the table name for the BronzeGCPOrgIamPolicyBinding entity.
	// It exists in this package in order to avoid circular dependency with the "bronzegcporgiampolicybinding" package.
	BindingsInverseTable = "gcp_org_iam_policy_bindings"
	// BindingsColumn is the table column denoting the bindings relation/edge.
	BindingsColumn = "bronze_gcp_org_iam_policy_bindings"
)

// Columns holds all SQL columns for bronzegcporgiampolicy fields.
var Columns = []string{
	FieldID,
	FieldCollectedAt,
...
// OrderOption defines the ordering options for the BronzeGCPOrgIamPolicy queries.
...
func newBindingsStep() *sqlgraph.Step {
	return sqlgraph.NewStep(
		...
		sqlgraph.To(BindingsInverseTable, BronzeGCPOrgIamPolicyBindingFieldID),
