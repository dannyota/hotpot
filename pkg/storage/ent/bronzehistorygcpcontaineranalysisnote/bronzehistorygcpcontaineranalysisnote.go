...
const (
	// Label holds the string label denoting the bronzehistorygcpcontaineranalysisnote type in the database.
	Label = "bronze_history_gcp_container_analysis_note"
	...
	// FieldRelatedURLJSON holds the string denoting the related_url_json field in the database.
	FieldRelatedURLJSON = "related_url_json"
	// FieldRelatedNoteNames holds the string denoting the related_note_names field in the database.
	FieldRelatedNoteNames = "related_note_names"
	...
	// FieldVulnerabilityAssessmentJSON holds the string denoting the vulnerability_assessment_json field in the database.
	FieldVulnerabilityAssessmentJSON = "vulnerability_assessment_json"
	...
	// Table holds the table name of the bronzehistorygcpcontaineranalysisnote in the database.
	Table = "gcp_containeranalysis_notes_history"
)

// Columns holds all SQL columns for bronzehistorygcpcontaineranalysisnote fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
	...
	FieldVulnerabilityAssessmentJSON,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPContainerAnalysisNote queries.
