...
const (
	// Label holds the string label denoting the bronzehistorygcporgpolicypolicy type in the database.
	Label = "bronze_history_gcp_org_policy_policy"
	...
	// Table holds the table name of the bronzehistorygcporgpolicypolicy in the database.
	Table = "gcp_orgpolicy_policies_history"
)

// Columns holds all SQL columns for bronzehistorygcporgpolicypolicy fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPOrgPolicyPolicy queries.
