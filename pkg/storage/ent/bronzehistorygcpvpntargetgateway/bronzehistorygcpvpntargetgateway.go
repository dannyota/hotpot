...
const (
	// Label holds the string label denoting the bronzehistorygcpvpntargetgateway type in the database.
	Label = "bronze_history_gcpvpn_target_gateway"
	...
	// Table holds the table name of the bronzehistorygcpvpntargetgateway in the database.
	Table = "gcp_compute_target_vpn_gateways_history"
)

// Columns holds all SQL columns for bronzehistorygcpvpntargetgateway fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPVPNTargetGateway queries.
