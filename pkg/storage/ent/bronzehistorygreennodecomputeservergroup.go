...
func (*BronzeHistoryGreenNodeComputeServerGroup) scanValues(columns []string) ([]any, error) {
...
// to the BronzeHistoryGreenNodeComputeServerGroup fields.
func (_m *BronzeHistoryGreenNodeComputeServerGroup) assignValues(columns []string, values []any) error {
	if m, n := len(values), len(columns); m < n {
		return fmt.Errorf("mismatch number of scan values: %d != %d", m, n)
	}
	for i := range columns {
		switch columns[i] {
		case bronzehistorygreennodecomputeservergroup.FieldID:
		...
		case bronzehistorygreennodecomputeservergroup.FieldHistoryID:
...
// Value returns the ent.Value that was dynamically selected and assigned to the BronzeHistoryGreenNodeComputeServerGroup.
// This includes values selected through modifiers, order, etc.
func (_m *BronzeHistoryGreenNodeComputeServerGroup) Value(name string) (ent.Value, error) {
	return _m.selectValues.Get(name)
}

// Update returns a builder for updating this BronzeHistoryGreenNodeComputeServerGroup.
// Note that you need to call BronzeHistoryGreenNodeComputeServerGroup.Unwrap() before calling this method if this BronzeHistoryGreenNodeComputeServerGroup
// was returned from a transaction, and the transaction was committed or rolled back.
func (_m *BronzeHistoryGreenNodeComputeServerGroup) Update() *BronzeHistoryGreenNodeComputeServerGroupUpdateOne {
	return NewBronzeHistoryGreenNodeComputeServerGroupClient(_m.config).UpdateOne(_m)
}

// Unwrap unwraps the BronzeHistoryGreenNodeComputeServerGroup entity that was returned from a transaction after it was closed,
// so that all future queries will be executed through the driver which created the transaction.
func (_m *BronzeHistoryGreenNodeComputeServerGroup) Unwrap() *BronzeHistoryGreenNodeComputeServerGroup {
	_tx, ok := _m.config.driver.(*txDriver)
	if !ok {
		panic("ent: BronzeHistoryGreenNodeComputeServerGroup is not a transactional entity")
	}
...
func (_m *BronzeHistoryGreenNodeComputeServerGroup) String() string {
	var builder strings.Builder
	builder.WriteString("BronzeHistoryGreenNodeComputeServerGroup(")
...
// BronzeHistoryGreenNodeComputeServerGroups is a parsable slice of BronzeHistoryGreenNodeComputeServerGroup.
type BronzeHistoryGreenNodeComputeServerGroups []*BronzeHistoryGreenNodeComputeServerGroup
