...
const (
	// Label holds the string label denoting the bronzehistorygcpiapiampolicy type in the database.
	Label = "bronze_history_gcpiapiam_policy"
	...
	// Table holds the table name of the bronzehistorygcpiapiampolicy in the database.
	Table = "gcp_iap_iam_policies_history"
)

// Columns holds all SQL columns for bronzehistorygcpiapiampolicy fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPIAPIAMPolicy queries.
