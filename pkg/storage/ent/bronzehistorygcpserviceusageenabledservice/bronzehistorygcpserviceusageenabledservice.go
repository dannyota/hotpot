...
const (
	// Label holds the string label denoting the bronzehistorygcpserviceusageenabledservice type in the database.
	Label = "bronze_history_gcp_service_usage_enabled_service"
	...
	// Table holds the table name of the bronzehistorygcpserviceusageenabledservice in the database.
	Table = "gcp_serviceusage_enabled_services_history"
)

// Columns holds all SQL columns for bronzehistorygcpserviceusageenabledservice fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPServiceUsageEnabledService queries.
