...
const (
	...
	FieldPort = "port"
	// Table holds the table name of the bronzehistorygcpcomputeinstancegroupnamedport in the database.
...
// OrderOption defines the ordering options for the BronzeHistoryGCPComputeInstanceGroupNamedPort queries.
