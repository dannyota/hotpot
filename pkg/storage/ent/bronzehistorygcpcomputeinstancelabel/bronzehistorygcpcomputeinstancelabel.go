...
const (
	// Label holds the string label denoting the bronzehistorygcpcomputeinstancelabel type in the database.
	Label = "bronze_history_gcp_compute_instance_label"
	...
	FieldValue = "value"
	// Table holds the table name of the bronzehistorygcpcomputeinstancelabel in the database.
	Table = "gcp_compute_instance_labels_history"
)

// Columns holds all SQL columns for bronzehistorygcpcomputeinstancelabel fields.
var Columns = []string{
	FieldID,
	FieldHistoryID,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPComputeInstanceLabel queries.
