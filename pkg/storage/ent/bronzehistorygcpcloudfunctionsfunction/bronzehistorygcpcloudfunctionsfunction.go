...
const (
	// Label holds the string label denoting the bronzehistorygcpcloudfunctionsfunction type in the database.
	Label = "bronze_history_gcp_cloud_functions_function"
	...
	// Table holds the table name of the bronzehistorygcpcloudfunctionsfunction in the database.
	Table = "gcp_cloudfunctions_functions_history"
)

// Columns holds all SQL columns for bronzehistorygcpcloudfunctionsfunction fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPCloudFunctionsFunction queries.
