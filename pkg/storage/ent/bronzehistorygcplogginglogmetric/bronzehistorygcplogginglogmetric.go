...
const (
	// Label holds the string label denoting the bronzehistorygcplogginglogmetric type in the database.
	Label = "bronze_history_gcp_logging_log_metric"
	...
	// Table holds the table name of the bronzehistorygcplogginglogmetric in the database.
	Table = "gcp_logging_log_metrics_history"
)

// Columns holds all SQL columns for bronzehistorygcplogginglogmetric fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPLoggingLogMetric queries.
