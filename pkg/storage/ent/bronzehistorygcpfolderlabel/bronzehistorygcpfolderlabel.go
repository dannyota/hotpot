...
const (
	// Label holds the string label denoting the bronzehistorygcpfolderlabel type in the database.
	Label = "bronze_history_gcp_folder_label"
	// FieldID holds the string denoting the id field in the database.
	FieldID = "id"
	// FieldHistoryID holds the string denoting the history_id field in the database.
	FieldHistoryID = "history_id"
	// FieldFolderHistoryID holds the string denoting the folder_history_id field in the database.
	FieldFolderHistoryID = "folder_history_id"
	...
	FieldValue = "value"
	// Table holds the table name of the bronzehistorygcpfolderlabel in the database.
	Table = "gcp_folder_labels_history"
)

// Columns holds all SQL columns for bronzehistorygcpfolderlabel fields.
var Columns = []string{
	FieldID,
	FieldHistoryID,
	FieldFolderHistoryID,
	FieldValidFrom,
	FieldValidTo,
	FieldKey,
	FieldValue,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPFolderLabel queries.
...
// ByFolderHistoryID orders the results by the folder_history_id field.
func ByFolderHistoryID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldFolderHistoryID, opts...).ToFunc()
}
