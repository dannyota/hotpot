...
const (
	// Label holds the string label denoting the bronzehistorygreennodeportalquota type in the database.
	Label = "bronze_history_green_node_portal_quota"
...
// Columns holds all SQL columns for bronzehistorygreennodeportalquota fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGreenNodePortalQuota queries.
