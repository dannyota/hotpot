...
const (
	// Label holds the string label denoting the bronzehistorygcpaccesscontextmanageraccesslevel type in the database.
	Label = "bronze_history_gcp_access_context_manager_access_level"
	...
	// Table holds the table name of the bronzehistorygcpaccesscontextmanageraccesslevel in the database.
	Table = "gcp_accesscontextmanager_access_levels_history"
)

// Columns holds all SQL columns for bronzehistorygcpaccesscontextmanageraccesslevel fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPAccessContextManagerAccessLevel queries.
