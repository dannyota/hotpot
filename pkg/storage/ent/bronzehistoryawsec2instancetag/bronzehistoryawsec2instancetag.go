...
const (
	// Label holds the string label denoting the bronzehistoryawsec2instancetag type in the database.
	Label = "bronze_history_awsec2instance_tag"
	...
	FieldValue = "value"
	// Table holds the table name of the bronzehistoryawsec2instancetag in the database.
	Table = "aws_ec2_instance_tags_history"
)

// Columns holds all SQL columns for bronzehistoryawsec2instancetag fields.
var Columns = []string{
	FieldID,
	FieldHistoryID,
...
// OrderOption defines the ordering options for the BronzeHistoryAWSEC2InstanceTag queries.
