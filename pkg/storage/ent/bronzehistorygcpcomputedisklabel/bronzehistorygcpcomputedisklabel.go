...
const (
	// Label holds the string label denoting the bronzehistorygcpcomputedisklabel type in the database.
	Label = "bronze_history_gcp_compute_disk_label"
	...
	FieldValue = "value"
	// Table holds the table name of the bronzehistorygcpcomputedisklabel in the database.
	Table = "gcp_compute_disk_labels_history"
)

// Columns holds all SQL columns for bronzehistorygcpcomputedisklabel fields.
var Columns = []string{
	FieldID,
	FieldHistoryID,
	FieldDiskHistoryID,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPComputeDiskLabel queries.
