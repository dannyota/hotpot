...
const (
	...
	FieldValue = "value"
	// Table holds the table name of the bronzehistorygcpcomputeimagelabel in the database.
...
// OrderOption defines the ordering options for the BronzeHistoryGCPComputeImageLabel queries.
