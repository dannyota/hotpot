...
const (
	// Label holds the string label denoting the bronzehistorygcporgiampolicy type in the database.
	Label = "bronze_history_gcp_org_iam_policy"
	...
	// Table holds the table name of the bronzehistorygcporgiampolicy in the database.
	Table = "gcp_org_iam_policies_history"
)

// Columns holds all SQL columns for bronzehistorygcporgiampolicy fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPOrgIamPolicy queries.
