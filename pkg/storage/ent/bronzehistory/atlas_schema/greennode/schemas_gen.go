...
func (BronzeHistoryGreenNodeComputeOSImage) Annotations() []schema.Annotation {
	anns := bronzehistory_greennode_compute.BronzeHistoryGreenNodeComputeOSImage{}.Annotations()
	for i, a := range anns {
...
func (BronzeHistoryGreenNodeComputeUserImage) Annotations() []schema.Annotation {
	anns := bronzehistory_greennode_compute.BronzeHistoryGreenNodeComputeUserImage{}.Annotations()
	for i, a := range anns {
		if v, ok := a.(entsql.Annotation); ok {
			v.Schema = "bronze_history"
			anns[i] = v
...
func (BronzeHistoryGreenNodeNetworkInterconnect) Annotations() []schema.Annotation {
	anns := bronzehistory_greennode_network.BronzeHistoryGreenNodeNetworkInterconnect{}.Annotations()
	for i, a := range anns {
		if v, ok := a.(entsql.Annotation); ok {
			v.Schema = "bronze_history"
			anns[i] = v
...
func (BronzeHistoryGreenNodeNetworkPeering) Annotations() []schema.Annotation {
	anns := bronzehistory_greennode_network.BronzeHistoryGreenNodeNetworkPeering{}.Annotations()
	for i, a := range anns {
		if v, ok := a.(entsql.Annotation); ok {
			v.Schema = "bronze_history"
			anns[i] = v
...
func (BronzeHistoryGreenNodeNetworkRouteTable) Annotations() []schema.Annotation {
	anns := bronzehistory_greennode_network.BronzeHistoryGreenNodeNetworkRouteTable{}.Annotations()
	for i, a := range anns {
		if v, ok := a.(entsql.Annotation); ok {
			v.Schema = "bronze_history"
			anns[i] = v
...
func (BronzeHistoryGreenNodeNetworkRouteTableRoute) Annotations() []schema.Annotation {
	anns := bronzehistory_greennode_network.BronzeHistoryGreenNodeNetworkRouteTableRoute{}.Annotations()
	for i, a := range anns {
		if v, ok := a.(entsql.Annotation); ok {
			v.Schema = "bronze_history"
			anns[i] = v
...
func (BronzeHistoryGreenNodeNetworkSubnet) Annotations() []schema.Annotation {
	anns := bronzehistory_greennode_network.BronzeHistoryGreenNodeNetworkSubnet{}.Annotations()
	for i, a := range anns {
		if v, ok := a.(entsql.Annotation); ok {
			v.Schema = "bronze_history"
			anns[i] = v
...
func (BronzeHistoryGreenNodeNetworkVpc) Annotations() []schema.Annotation {
	anns := bronzehistory_greennode_network.BronzeHistoryGreenNodeNetworkVpc{}.Annotations()
	for i, a := range anns {
		if v, ok := a.(entsql.Annotation); ok {
			v.Schema = "bronze_history"
			anns[i] = v
