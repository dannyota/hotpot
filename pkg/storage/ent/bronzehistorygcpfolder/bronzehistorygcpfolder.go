...
const (
	// Label holds the string label denoting the bronzehistorygcpfolder type in the database.
	Label = "bronze_history_gcp_folder"
	...
	// Table holds the table name of the bronzehistorygcpfolder in the database.
	Table = "gcp_folders_history"
)

// Columns holds all SQL columns for bronzehistorygcpfolder fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPFolder queries.
