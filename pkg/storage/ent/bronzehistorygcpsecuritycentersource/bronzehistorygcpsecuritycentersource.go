...
const (
	// Label holds the string label denoting the bronzehistorygcpsecuritycentersource type in the database.
	Label = "bronze_history_gcp_security_center_source"
	...
	// Table holds the table name of the bronzehistorygcpsecuritycentersource in the database.
	Table = "gcp_securitycenter_sources_history"
)

// Columns holds all SQL columns for bronzehistorygcpsecuritycentersource fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPSecurityCenterSource queries.
