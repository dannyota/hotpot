...
const (
	// Label holds the string label denoting the bronzehistorygcpfolderiampolicy type in the database.
	Label = "bronze_history_gcp_folder_iam_policy"
	...
	// Table holds the table name of the bronzehistorygcpfolderiampolicy in the database.
	Table = "gcp_folder_iam_policies_history"
)

// Columns holds all SQL columns for bronzehistorygcpfolderiampolicy fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPFolderIamPolicy queries.
