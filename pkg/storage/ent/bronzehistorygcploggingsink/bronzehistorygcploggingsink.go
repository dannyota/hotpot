...
const (
	// Label holds the string label denoting the bronzehistorygcploggingsink type in the database.
	Label = "bronze_history_gcp_logging_sink"
	...
	// Table holds the table name of the bronzehistorygcploggingsink in the database.
	Table = "gcp_logging_sinks_history"
)

// Columns holds all SQL columns for bronzehistorygcploggingsink fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPLoggingSink queries.
