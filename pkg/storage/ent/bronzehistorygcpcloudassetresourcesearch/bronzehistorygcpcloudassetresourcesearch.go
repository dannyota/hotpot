...
const (
	// Label holds the string label denoting the bronzehistorygcpcloudassetresourcesearch type in the database.
	Label = "bronze_history_gcp_cloud_asset_resource_search"
	...
	// Table holds the table name of the bronzehistorygcpcloudassetresourcesearch in the database.
	Table = "gcp_cloudasset_resource_searches_history"
)

// Columns holds all SQL columns for bronzehistorygcpcloudassetresourcesearch fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPCloudAssetResourceSearch queries.
