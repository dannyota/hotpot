...
const (
	// Label holds the string label denoting the bronzehistorygcpcomputeinstancemetadata type in the database.
	Label = "bronze_history_gcp_compute_instance_metadata"
	...
	FieldValue = "value"
	// Table holds the table name of the bronzehistorygcpcomputeinstancemetadata in the database.
	Table = "gcp_compute_instance_metadata_history"
)

// Columns holds all SQL columns for bronzehistorygcpcomputeinstancemetadata fields.
var Columns = []string{
	FieldID,
	FieldHistoryID,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPComputeInstanceMetadata queries.
