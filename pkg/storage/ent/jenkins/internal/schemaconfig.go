...
type SchemaConfig struct {
	BronzeHistoryJenkinsBuild     string // BronzeHistoryJenkinsBuild table.
	BronzeHistoryJenkinsBuildRepo string // BronzeHistoryJenkinsBuildRepo table.
	BronzeHistoryJenkinsJob       string // BronzeHistoryJenkinsJob table.
	BronzeJenkinsBuild            string // BronzeJenkinsBuild table.
	BronzeJenkinsBuildRepo        string // BronzeJenkinsBuildRepo table.
	BronzeJenkinsJob              string // BronzeJenkinsJob table.
}
