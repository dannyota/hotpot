...
const (
	// Label holds the string label denoting the bronzehistorygcpcomputeimagelicense type in the database.
	Label = "bronze_history_gcp_compute_image_license"
	...
	// Table holds the table name of the bronzehistorygcpcomputeimagelicense in the database.
	Table = "gcp_compute_image_licenses_history"
)

// Columns holds all SQL columns for bronzehistorygcpcomputeimagelicense fields.
var Columns = []string{
	FieldID,
	FieldHistoryID,
	FieldImageHistoryID,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPComputeImageLicense queries.
...
func ByImageHistoryID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldImageHistoryID, opts...).ToFunc()
}
