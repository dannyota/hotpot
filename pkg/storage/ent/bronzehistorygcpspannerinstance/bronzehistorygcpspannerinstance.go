...
const (
	// Label holds the string label denoting the bronzehistorygcpspannerinstance type in the database.
	Label = "bronze_history_gcp_spanner_instance"
	...
	// Table holds the table name of the bronzehistorygcpspannerinstance in the database.
	Table = "gcp_spanner_instances_history"
)

// Columns holds all SQL columns for bronzehistorygcpspannerinstance fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPSpannerInstance queries.
