...
const (
	// Label holds the string label denoting the bronzehistorygcpiamserviceaccount type in the database.
	Label = "bronze_history_gcpiam_service_account"
	...
	// Table holds the table name of the bronzehistorygcpiamserviceaccount in the database.
	Table = "gcp_iam_service_accounts_history"
)

// Columns holds all SQL columns for bronzehistorygcpiamserviceaccount fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPIAMServiceAccount queries.
