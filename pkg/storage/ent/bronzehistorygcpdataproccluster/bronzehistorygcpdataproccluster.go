...
const (
	// Label holds the string label denoting the bronzehistorygcpdataproccluster type in the database.
	Label = "bronze_history_gcp_dataproc_cluster"
	...
	// Table holds the table name of the bronzehistorygcpdataproccluster in the database.
	Table = "gcp_dataproc_clusters_history"
)

// Columns holds all SQL columns for bronzehistorygcpdataproccluster fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPDataprocCluster queries.
