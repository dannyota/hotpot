...
const (
	// Label holds the string label denoting the bronzehistorygcpcomputetargetsslproxy type in the database.
	Label = "bronze_history_gcp_compute_target_ssl_proxy"
	...
	// Table holds the table name of the bronzehistorygcpcomputetargetsslproxy in the database.
	Table = "gcp_compute_target_ssl_proxies_history"
)

// Columns holds all SQL columns for bronzehistorygcpcomputetargetsslproxy fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPComputeTargetSslProxy queries.
