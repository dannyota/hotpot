...
const (
	// Label holds the string label denoting the bronzehistorygreennodeportalregion type in the database.
	Label = "bronze_history_green_node_portal_region"
	...
	// Table holds the table name of the bronzehistorygreennodeportalregion in the database.
	Table = "greennode_portal_regions_history"
)

// Columns holds all SQL columns for bronzehistorygreennodeportalregion fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGreenNodePortalRegion queries.
