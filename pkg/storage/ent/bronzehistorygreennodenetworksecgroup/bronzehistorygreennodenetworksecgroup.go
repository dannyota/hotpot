...
const (
	// Label holds the string label denoting the bronzehistorygreennodenetworksecgroup type in the database.
	Label = "bronze_history_green_node_network_secgroup"
	...
	// Table holds the table name of the bronzehistorygreennodenetworksecgroup in the database.
	Table = "greennode_network_secgroups_history"
)

// Columns holds all SQL columns for bronzehistorygreennodenetworksecgroup fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGreenNodeNetworkSecgroup queries.
