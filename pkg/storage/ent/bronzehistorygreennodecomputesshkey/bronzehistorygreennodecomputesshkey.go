...
const (
	// Label holds the string label denoting the bronzehistorygreennodecomputesshkey type in the database.
	Label = "bronze_history_green_node_compute_ssh_key"
	...
	// Table holds the table name of the bronzehistorygreennodecomputesshkey in the database.
	Table = "greennode_compute_ssh_keys_history"
)

// Columns holds all SQL columns for bronzehistorygreennodecomputesshkey fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGreenNodeComputeSSHKey queries.
