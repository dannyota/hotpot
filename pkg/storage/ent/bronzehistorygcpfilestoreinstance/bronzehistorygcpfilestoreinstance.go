...
const (
	// Label holds the string label denoting the bronzehistorygcpfilestoreinstance type in the database.
	Label = "bronze_history_gcp_filestore_instance"
	...
	// Table holds the table name of the bronzehistorygcpfilestoreinstance in the database.
	Table = "gcp_filestore_instances_history"
)

// Columns holds all SQL columns for bronzehistorygcpfilestoreinstance fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPFilestoreInstance queries.
