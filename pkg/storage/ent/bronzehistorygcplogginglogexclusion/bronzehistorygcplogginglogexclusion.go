...
const (
	// Label holds the string label denoting the bronzehistorygcplogginglogexclusion type in the database.
	Label = "bronze_history_gcp_logging_log_exclusion"
	...
	// Table holds the table name of the bronzehistorygcplogginglogexclusion in the database.
	Table = "gcp_logging_log_exclusions_history"
)

// Columns holds all SQL columns for bronzehistorygcplogginglogexclusion fields.
var Columns = []string{
	FieldID,
	FieldValidFrom,
	FieldValidTo,
...
// OrderOption defines the ordering options for the BronzeHistoryGCPLoggingLogExclusion queries.
