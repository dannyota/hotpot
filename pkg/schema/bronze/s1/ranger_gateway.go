...
// BronzeS1RangerGateway represents a SentinelOne Ranger network gateway in the bronze layer.
type BronzeS1RangerGateway struct {
	ent.Schema
}

func (BronzeS1RangerGateway) Mixin() []ent.Mixin {
	return []ent.Mixin{
		mixin.Timestamp{},
	}
}

func (BronzeS1RangerGateway) Fields() []ent.Field {
	return []ent.Field{
		field.String("id").
			StorageKey("resource_id").
			Unique().
			Immutable().
			Comment("SentinelOne Ranger gateway ID"),
		field.String("ip").
			Optional(),
...
func (BronzeS1RangerGateway) Indexes() []ent.Index {
	return []ent.Index{
...
func (BronzeS1RangerGateway) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.Annotation{Table: "s1_ranger_gateways"},
	}
}
