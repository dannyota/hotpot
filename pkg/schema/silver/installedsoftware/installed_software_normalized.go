...
// SilverInstalledSoftwareNormalized holds per-provider normalized rows before merge.
type SilverInstalledSoftwareNormalized struct {
	ent.Schema
}

func (SilverInstalledSoftwareNormalized) Fields() []ent.Field {
	return []ent.Field{
...
func (SilverInstalledSoftwareNormalized) Indexes() []ent.Index {
	return []ent.Index{
...
func (SilverInstalledSoftwareNormalized) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.Annotation{Table: "installed_software_normalized"},
	}
}
