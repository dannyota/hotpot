...
// SilverK8sNode is the final merged Kubernetes node table.
type SilverK8sNode struct {
	ent.Schema
}

func (SilverK8sNode) Mixin() []ent.Mixin {
	return []ent.Mixin{
		silvermixin.Timestamp{},
	}
}

func (SilverK8sNode) Fields() []ent.Field {
	return []ent.Field{
...
func (SilverK8sNode) Edges() []ent.Edge {
	return []ent.Edge{
		edge.To("bronze_links", SilverK8sNodeBronzeLink.Type),
	}
}

func (SilverK8sNode) Indexes() []ent.Index {
	return []ent.Index{
