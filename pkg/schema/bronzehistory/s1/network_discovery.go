...
// BronzeHistoryS1NetworkDiscovery stores historical snapshots of SentinelOne XDR network discovery devices.
type BronzeHistoryS1NetworkDiscovery struct {
	ent.Schema
}

func (BronzeHistoryS1NetworkDiscovery) Mixin() []ent.Mixin {
	return []ent.Mixin{historymixin.Timestamp{}}
}

func (BronzeHistoryS1NetworkDiscovery) Fields() []ent.Field {
	return []ent.Field{
		field.Uint("id").StorageKey("history_id"),
		field.String("resource_id").
			NotEmpty().
			Comment("Link to bronze network discovery device by resource_id"),
...
func (BronzeHistoryS1NetworkDiscovery) Indexes() []ent.Index {
	return []ent.Index{
...
func (BronzeHistoryS1NetworkDiscovery) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.Annotation{Table: "s1_network_discoveries_history"},
	}
}
