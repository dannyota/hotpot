...
func (h *HistoryService) CreateHistory(ctx context.Context, tx *ent.Tx, data *GLBRegionData, now time.Time) error {
...
func (h *HistoryService) UpdateHistory(ctx context.Context, tx *ent.Tx, old *ent.BronzeGreenNodeGLBGlobalRegion, new *GLBRegionData, now time.Time) error {
