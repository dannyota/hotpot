...
func (h *HistoryService) CreateHistory(ctx context.Context, tx *entrun.Tx, data *RevisionData, now time.Time) error {
...
func (h *HistoryService) UpdateHistory(ctx context.Context, tx *entrun.Tx, old *entrun.BronzeGCPRunRevision, new *RevisionData, diff *RevisionDiff, now time.Time) error {
