...
func (h *HistoryService) CreateHistory(ctx context.Context, tx *entcompute.Tx, data *TargetInstanceData, now time.Time) error {
...
func (h *HistoryService) UpdateHistory(ctx context.Context, tx *entcompute.Tx, old *entcompute.BronzeGCPComputeTargetInstance, new *TargetInstanceData, diff *TargetInstanceDiff, now time.Time) error {
	if !diff.IsChanged {
		return nil
	}
