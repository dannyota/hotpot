...
func (h *HistoryService) CreateHistory(ctx context.Context, tx *entcompute.Tx, data *SecurityPolicyData, now time.Time) error {
...
func (h *HistoryService) UpdateHistory(ctx context.Context, tx *entcompute.Tx, old *entcompute.BronzeGCPComputeSecurityPolicy, new *SecurityPolicyData, diff *SecurityPolicyDiff, now time.Time) error {
	if !diff.IsChanged {
		return nil
	}
