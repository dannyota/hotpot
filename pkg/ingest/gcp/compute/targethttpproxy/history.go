...
func (h *HistoryService) CreateHistory(ctx context.Context, tx *entcompute.Tx, data *TargetHttpProxyData, now time.Time) error {
...
func (h *HistoryService) UpdateHistory(ctx context.Context, tx *entcompute.Tx, old *entcompute.BronzeGCPComputeTargetHttpProxy, new *TargetHttpProxyData, diff *TargetHttpProxyDiff, now time.Time) error {
	if !diff.IsChanged {
		return nil
	}
