...
type ServiceRegistration struct {
	...
	// NewParams creates the workflow params struct from projectID, region, and quotaProjectID.
	// quotaProjectID is the GCP project to use for API billing/quota; empty means default.
	NewParams func(projectID, region, quotaProjectID string) any
